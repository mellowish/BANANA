...
copd3a <- subset(copd2, visitnum==1)[,-c(2,6,7,8,9,10,11,12,13, 45,48:58)]
copd3b <- subset(copd2, visitnum==2)[,-c(2,6,7,8,9,10,11,12,13,45, 48:58)]
copd3c <- subset(copd2)[,c(1,2,6,7,8,9,10,11,12,13,45, 48:58)]
...
# AS OF MAY 2019, WE DECIDED THAT WE WANT EACH ROW TO HAVE ALL PHENOTYPIC CHARACTERISTICS WHICH BRINGS UP THE QUESTION OF WHETHER WE EVEN WANT TO USE THE LONG DATASET. I'm going to make a new dataset to do this now. 
...
### OK. SOMEWHERE IN HERE, I NEED TO MAKE DECISIONS ABOUT WHAT IS GOING TO MAINTAINED IN EACH ROW SO THAT SUBJECTS AREN'T NECESSARILY USING TIME=VARYING COVARIATES - THIS NEEDS TO HAPPEN BEFORE WE INCLUDE LFUSURV. 
